...
const hextable = (new TextEncoder).encode("0123456789abcdef"), _TextDecoder = TextDecoder, _TextEncoder = TextEncoder, notImplementedEncodings = [ "utf16le", "latin1", "ascii", "binary", "ucs2" ], encodingOps = {
  utf8: {
...
nativeModulePolyfill.set("buffer", createNativeModule("buffer", nodeBuffer)), nativeModulePolyfill.set("fs", createNativeModule("fs", nodeFs)), 
nativeModulePolyfill.set("events", createNativeModule("events", nodeEvents)), nativeModulePolyfill.set("os", createNativeModule("os", nodeOs)), 
nativeModulePolyfill.set("path", createNativeModule("path", nodePath)), nativeModulePolyfill.set("timers", createNativeModule("timers", nodeTimers)), 
nativeModulePolyfill.set("util", createNativeModule("util", nodeUtil)), nativeModulePolyfill.set("querystring", createNativeModule("querystring", nodeQueryString));
