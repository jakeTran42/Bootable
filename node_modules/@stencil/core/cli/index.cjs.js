...
exports.run = async e => {
  ...
  try {
    const e = ((e, t) => {
      ...
      if (s.args = t.slice(), s.args.length > 0 && s.args[0] && !s.args[0].startsWith("-") && (s.task = s.args[0]), 
      parseArgs(s, s.args, s.knownArgs), "node" === e.name) {
        const t = (e => {
          let t = [];
          try {
        ...
        parseArgs(s, t, s.knownArgs), t.forEach(e => {
